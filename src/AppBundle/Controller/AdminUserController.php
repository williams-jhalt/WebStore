...
class AdminUserController extends Controller {
     ...
     * @Template("admin/users/list.html.twig")
     */
    ...
    public function addCustomerAction($id, Request $request) {
        ...
        return $this->redirectToRoute('admin_edit_user', array('id' => $id));
    }
     ...
     * @Template("admin/users/change_password.html.twig")
     */
    ...
    /**
     * @Route("/remove/{id}", name="admin_remove_user")
     */
